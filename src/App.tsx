...
import { Rainbow, Sparkles, Shuffle, Languages, Home, Heart } from 'lucide-react';
...
const chakras = [
  {
    ...
    affirmations: [
      ...
      { en: "I am amazed at the incredible capabilities within my body", zh: "我對體內那不可思議的能力感到讚嘆" },
  ...
  },
  {
    ...
    affirmations: [
      ...
      { en: "Losing control is perfectly okay", zh: "失去控制是無傷大雅的" },
      { en: "I am grateful for the company of good friends", zh: "我很高興有好朋友的陪伴" },
      { en: "Life is beautiful, and I give back for all the goodness I receive", zh: "生命是美好的，我極盡所能地回饋我所接受的所有美善" },
      { en: "Play is an important part of my life", zh: "玩是我生活中的重要因素" },
      { en: "I enjoy my sexual energy, which is natural and beautiful", zh: "我歡愉於我的性能量，那是自然而且美好的" },
      { en: "The atmosphere in my home is happy and bright", zh: "我家的氣氛是快樂且光明的" },
      { en: "I see vibrant life energy everywhere", zh: "我隨處都看見旺盛的生命能量" },
      { en: "I allow myself to enjoy sexuality", zh: "我允許自己享受性" },
      { en: "Everyone has enough space to joyfully express our unique creativity", zh: "每個人都有足夠的空間喜悅地表達我們獨一無二的創造力" },
      { en: "You can find joy in unexpected places", zh: "你可以在意想不到的地方找到喜悅" },
      ...
      { en: "By affirming life and demonstrating the joy of living, my love, power, and wisdom grow", zh: "藉著肯定生命並呈現活在其中的喜悅，我的愛、力量與智慧增長" },
      { en: "Sex relaxes me and makes me calm and beautiful", zh: "性使我放鬆，並使我平靜、美麗" },
      { en: "I enjoy encountering new ideas", zh: "我喜歡接觸新的想法" },
      { en: "I move toward my goals with ease and joy", zh: "我輕易和喜悅地朝著目標前進" },
  ...
  },
  {
    ...
    affirmations: [
      ...
      { en: "I know the difference between true needs and feelings of lack", zh: "我知道真實的需要和匱乏感之間的區別" },
      ...
      { en: "I welcome everything that makes me happy", zh: "我觀迎所有令我快樂的事情" },
      ...
      { en: "I am a wonderful, radiant, and divine being", zh: "我是一個很棒的、發光的、並且充滿神性的個體" },
      { en: "I am in absolute safety", zh: "我身處絕對安全之中" },
      { en: "I am peaceful, and everything is going well", zh: "我很平安，而且一切都很順利" },
      { en: "I see goodness in myself and everyone else", zh: "我看到自己和每個人的美善" },
      ...
      { en: "I feel safe whether or not my partner agrees with me", zh: "無論我的伙伴是否認同我，我都覺得安全" }
    ]
  },
  {
    name: {
    ...
    affirmations: [
      ...
      { en: "To my partner, I am lovable; to me, he is lovable too", zh: "就我的伙伴而言，我是可愛的；就我而言，他也是可愛的" },
      ...
      { en: "I let go of expectations and open my heart to experience the abundance brought by differences", zh: "我放下所有的期待敞開心胸去體驗差異帶給我的豐盈" },
      { en: "I love him, so I show my true self without hiding. That's why I thank him", zh: "我愛他所以在他面前我毫不隱瞞，呈現真實的自己。這是我感謝他的原因。" }
    ]
  },
  {
    name: {
    ...
    affirmations: [
      ...
      { en: "I am free to travel anywhere", zh: "我可公自由自在地去任何地方旅行" },
      { en: "In truth, giving and receiving are the same", zh: "在真理中，付出和接受是同一件事" },
      { en: "What I give to others returns to me many times over", zh: "我送給別人的東西，會很多倍地回饋到我身上" },
      ...
      { en: "I communicate love, truth, and care", zh: "我傳達愛、真理和關懷" },
      ...
      { en: "I observe my feelings rather than telling others how to feel", zh: "我觀察自己的感覺，而非告訴別人他們應該如何感覺" },
      ...
      { en: "I choose my words carefully because they create reality", zh: "我仔細地選擇我的話語，因為它們會創造實相" },
      ...
      { en: "When I ask others for help, I am still worthy of love", zh: "當我請求別人協助的時候，我依然值得被愛" },
  ...
  },
  {
    ...
    affirmations: [
      ...
      { en: "I choose to take responsibility for the power of my thoughts", zh: "我選擇對我念力所產生的力量負責" },
      { en: "I treat myself and others with compassion", zh: "我以慈悲心對待自己與別人" },
      { en: "I feel safe in the flow of life", zh: "在生命之流裡，我感到安全" },
      { en: "I break through the protective patterns set by my parents", zh: "我突破了父母，為保護我而設立的規範" },
      { en: "I observe my thoughts and remove those that cause pain, focusing on positive ideas", zh: "我觀照我的思維，剷除那些像雜草般令我痛苦的念頭，並專注於對我有益的想法" },
      ...
      { en: "Right now, I am creating my future", zh: "就在當下，我創造我的未來" },
                ...
                >
                  <div className="flip-card-inner">
                    <div className="flip-card-front">
                      <div className="w-full h-full bg-gradient-to-br from-purple-500 to-pink-500 rounded-xl shadow-xl transform transition-all duration-300 hover:scale-105 hover:shadow-2xl" />
                    </div>
